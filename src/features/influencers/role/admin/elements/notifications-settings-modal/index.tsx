...
import { TNotificationsSettingsModalProps } from 'features/influencers/role/admin/elements/notifications-settings-modal/types';
import { NotificationsSettingsModalMain } from 'features/influencers/role/admin/elements/notifications-settings-modal/styles';
      ...
      <NotificationsSettingsModalMain columns={1}>
        <Stack>
          ...
          <Stack>
            ...
            >
              <Switch label="Accepted" />
              <Switch label="Signed" />
              <Switch label="Submited" />
            </Stack>
          </Stack>
        </Stack>
